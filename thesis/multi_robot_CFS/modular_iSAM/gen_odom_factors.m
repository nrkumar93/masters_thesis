...
odom_noise = noiseModel.Diagonal.Sigmas([odometry_covariance_per_time_ratio(robot_id, 1); ...
                                         odometry_covariance_per_time_ratio(robot_id, 5); ...
                                         odometry_covariance_per_time_ratio(robot_id, 9)] * (del_t^2));
